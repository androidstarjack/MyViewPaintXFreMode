package cn.r.topic.edittext.android.widget;
	...
	private void initView() {
		...
		this.setOnKeyListener(new View.OnKeyListener() {
			...
			public boolean onKey(View v, int keyCode, KeyEvent event) {
				...
				// 当为删除键并且是按下动作时执行
				//
				// int selectionStart = getSelectionStart();// 当前光标位置
				// int selectionEnd = getSelectionEnd();// 光标结束位置
				//
