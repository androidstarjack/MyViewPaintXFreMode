...
public class UnfoldButton extends ImageButton {
...
//                getViewTreeObserver().removeOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
//                    @Override
//                    public void onGlobalLayout() {
//
//                    }
//                });
    ...
    private void init() {
        ...
        mBackground.setBackgroundColor(getResources().getColor(R.color.colorAccent));
